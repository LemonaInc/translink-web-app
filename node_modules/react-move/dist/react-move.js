    ...
    if (nameSpace === null) {
      ...
      stateTween = function stateTween(t) {
        _this.setState(function (state) {
          ...
          return _ref2 = {}, _ref2[nameSpace] = _extends({}, state[nameSpace], (_babelHelpers$extends = {}, _babelHelpers$extends[attr] = i(t), _babelHelpers$extends)), _ref2;
        });
      };
    }
        ...
        if (Array.isArray(val)) {
          if (val.length === 1) {
            ...
            _this.setState(function (state) {
              ...
              return _ref = {}, _ref[stateKey] = _extends({}, state[stateKey], (_babelHelpers$extends = {}, _babelHelpers$extends[attr] = val[0], _babelHelpers$extends)), _ref;
            });
          ...
          var getResonanceCustomTween = function getResonanceCustomTween() {
            var resonanceCustomTween = function resonanceCustomTween(t) {
              _this.setState(function (state) {
                ...
                return _ref2 = {}, _ref2[stateKey] = _extends({}, state[stateKey], (_babelHelpers$extends2 = {}, _babelHelpers$extends2[attr] = val(t), _babelHelpers$extends2)), _ref2;
              });
            };
          ...
          _this.setState(function (state) {
            ...
            return _ref3 = {}, _ref3[stateKey] = _extends({}, state[stateKey], (_babelHelpers$extends3 = {}, _babelHelpers$extends3[attr] = val, _babelHelpers$extends3)), _ref3;
          });
...
var Animate = function (_Component) {
  ...
  function Animate() {
    ...
    return _ret = (_temp = (_this = possibleConstructorReturn(this, _Component.call.apply(_Component, [this].concat(args))), _this), _this.state = typeof _this.props.start === 'function' ? _this.props.start() : _this.props.start, _this.checkTransitionStatus = function () {
    ...
    }, _this.interval = null, _this.renderNull = true, _temp), possibleConstructorReturn(_this, _ret);
  }
...
var NodeGroup = function (_Component) {
  ...
  function NodeGroup() {
    ...
    return _ret = (_temp = (_this = possibleConstructorReturn(this, _Component.call.apply(_Component, [this].concat(args))), _this), _this.state = {
      ...
      _this.renderNodes();
    }, _this.nodeHash = {}, _this.nodeKeys = [], _this.interval = null, _this.unmounting = false, _temp), possibleConstructorReturn(_this, _ret);
  }
